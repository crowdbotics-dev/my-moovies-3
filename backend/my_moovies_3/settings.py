"""
Django settings for my_moovies_3 project.
...
ROOT_URLCONF = 'my_moovies_3.urls'
...
WSGI_APPLICATION = 'my_moovies_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_moovies_3 API",
    "DESCRIPTION": "API documentation for my_moovies_3 App",
    "VERSION": "v1",
}
